...
public class myframe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jRadioButton2.setFont(new java.awt.Font("Segoe UI Light", 1, 18)); // NOI18N
 ...
 try {
            ...
            PreparedStatement ps=con.prepareStatement("insert into fidel(name,age,gender)values(?,?,?)");
            ps.setString(1, name);
            ps.setString(2, age);
    ...
    try {
            ...
            Class.forName("com.mysql.cj.jdbc.Driver");
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost/school","root","");
            PreparedStatement ps=con.prepareStatement("Update fidel set name=?,age=?,gender=? where id=?");
            ps.setString(1, name);
            ps.setString(2, age);
           if(jRadioButton1.isSelected())
           {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
      try {
            ...
            Class.forName("com.mysql.cj.jdbc.Driver");
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost/school","root","");
            PreparedStatement ps=con.prepareStatement("Delete from fidel where id=?");
